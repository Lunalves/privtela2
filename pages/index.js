      ...
      <div className="relative max-w-3xl mx-auto rounded-3xl overflow-hidden bg-white shadow-lg mt-4">
        ...
        <div className="bg-white p-6 -mt-12 relative z-10">
          ...
          <div className="flex space-x-2 mt-2">
            ...
            <a href="https://discord.gg/WMm5pyXSCS" target="_blank" rel="noopener noreferrer" className="w-6 h-6 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors cursor-pointer">
              <svg className="w-4 h-4 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
